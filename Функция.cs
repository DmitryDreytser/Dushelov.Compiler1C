...
{
  internal class Функция : Процедура
  {
    internal new void Code(CodeStruct node, ref string code)
    {
      code = code + Environment.NewLine + "        private static object " + this.Name + "(";
